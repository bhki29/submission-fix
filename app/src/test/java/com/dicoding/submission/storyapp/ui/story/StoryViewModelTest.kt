...
import com.dicoding.submission.storyapp.DataDummy
import com.dicoding.submission.storyapp.MainDispatcherRule
...
import com.dicoding.submission.storyapp.getOrAwaitValue
...
class StoryViewModelTest {
    ...
    fun `when Get Stories Should Not Null and Return Data`() = runTest {
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoryPagingAdapter.StoryDiffCallback(),
